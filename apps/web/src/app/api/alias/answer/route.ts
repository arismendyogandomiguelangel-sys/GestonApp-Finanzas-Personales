...
export const POST = async (request: Request): Promise<Response> =>
  handleRoute(
    { route: "/api/alias/answer", method: "POST", internalErrorMessage: "Failed to record learning answer" },
    async (): Promise<Response> => {
      ...
      await handleQuestionResponse(userId, workspaceId, questionId, "answer");
      return Response.json({ ok: true });
    },
  );
